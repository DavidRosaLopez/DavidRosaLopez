					...
					<tbody>
						<s:iterator value="pedidos">
							<tr>
								...
								<td>
									<s:url action="mostrarPDF" id="mostrarURL">
										<s:param name="idPedido" value="%{idPedido}"></s:param>
									</s:url> 
									<s:a href="%{mostrarURL}" class="btn btn-warning btn-xs" target="_blank">
								...
								<td>
									<s:url action="enviarPedido" id="enviarURL">
										<s:param name="idPedido" value="%{idPedido}"></s:param>
									</s:url> 
									<s:a href="%{enviarURL}" class="btn btn-info btn-xs">
